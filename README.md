...
3.  **Export:** Use the "Save as PDB", "Save as XYZ", "Save as OBJ Wireframe", "Save as OBJ MESH", "Save as STL" and "Save as GLB" buttons to save the 3D structure to your disk.
